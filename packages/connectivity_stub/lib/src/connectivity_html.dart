...
class Connectivity {
  ...
  Stream<ConnectivityResult> get onConnectivityChanged {
    final result = StreamController<ConnectivityResult>();
     window.onOnline.listen((_) => result.add(ConnectivityResult.wifi));
     window.onOffline.listen((_) => result.add(ConnectivityResult.none));
  ...
  Future<ConnectivityResult> checkConnectivity() {
    return Future.value(window.navigator.onLine ? ConnectivityResult.wifi : ConnectivityResult.none);
  }
